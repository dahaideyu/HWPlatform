...
namespace HW.SF.Models.SYSModel
{
    ...
    public class Sys_ModuleForm :IBaseModel<string>
    {
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_FormJson != null && 2147483647 < this.F_FormJson.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_FormJson should not be greater then 2147483647!");
            }
