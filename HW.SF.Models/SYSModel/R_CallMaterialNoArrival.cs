...
namespace HW.SF.Models.SYSModel
{
    ...
    public class R_CallMaterialNoArrival :IBaseModel<string>
    {
	  ...
	  ///已发布的数量
	  ///</summary>
	          public Decimal? F_CallRates{get;set;}
	  ///<summary>
	  ///已完成的数量
	  ///</summary>
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_Reason != null && 500 < this.F_Reason.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_Reason should not be greater then 500!");
            }
