...
namespace HW.SF.Models.SYSModel
{
    ...
    public class Sys_FilterIP :IBaseModel<string>
    {
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_StartIP != null && 50 < this.F_StartIP.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_StartIP should not be greater then 50!");
            }
            if (this.F_EndIP != null && 50 < this.F_EndIP.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_EndIP should not be greater then 50!");
            }
