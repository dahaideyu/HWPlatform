...
namespace HW.SF.Models.SYSModel
{
    ...
    public class G_UserRateHour :IBaseModel<string>
    {
	  ...
	  ///
	  ///</summary>
	          public Decimal? F_UserRate{get;set;}
	  ///<summary>
	  ///排序码
	  ///</summary>
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (string.IsNullOrEmpty(this.F_UserId))
            {
                validatorResult = false;
                this.ErrorList.Add("The F_UserId should not be empty!");
            }
