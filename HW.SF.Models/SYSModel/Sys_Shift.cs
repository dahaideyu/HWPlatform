...
namespace HW.SF.Models.SYSModel
{
    ...
    public class Sys_Shift :IBaseModel<string>
    {
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_Name != null && 50 < this.F_Name.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_Name should not be greater then 50!");
            }
