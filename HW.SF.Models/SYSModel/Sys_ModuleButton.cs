...
namespace HW.SF.Models.SYSModel
{
    ...
    public class Sys_ModuleButton :IBaseModel<string>
    {
	  ...
	  ///名称
	  ///</summary>
	          public String F_EngName{get;set;}
	  ///<summary>
	  ///名称
	  ///</summary>
	  ...
	  ///位置
	  ///</summary>
	          public Int32? F_Location{get;set;}
	  ///<summary>
	  ///事件
	  ///</summary>
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_EngName != null && 50 < this.F_EngName.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_EngName should not be greater then 50!");
            }
            ...
            if (this.F_Icon != null && 50 < this.F_Icon.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_Icon should not be greater then 50!");
            }
            if (this.F_JsEvent != null && 50 < this.F_JsEvent.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_JsEvent should not be greater then 50!");
            }
            if (this.F_UrlAddress != null && 500 < this.F_UrlAddress.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_UrlAddress should not be greater then 500!");
            }
