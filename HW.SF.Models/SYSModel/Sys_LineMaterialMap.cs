...
namespace HW.SF.Models.SYSModel
{
    ...
    public class Sys_LineMaterialMap :IBaseModel<string>
    {
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_LineId != null && 50 < this.F_LineId.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_LineId should not be greater then 50!");
            }
