...
namespace HW.SF.Models.SYSModel
{
    ...
    public class Sys_Module :IBaseModel<string>
    {
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_Target != null && 50 < this.F_Target.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_Target should not be greater then 50!");
            }
