...
namespace HW.SF.Models.SYSModel
{
    ...
    public class G_WorkerStatusLog :IBaseModel<string>
    {
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_UserStatus != null && 50 < this.F_UserStatus.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_UserStatus should not be greater then 50!");
            }
