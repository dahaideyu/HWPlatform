...
namespace HW.SF.Models.SYSModel
{
    ...
    public class G_Order :IBaseModel<string>
    {
	  ...
	  ///已发布的数量
	  ///</summary>
	          public Decimal? F_PushQty{get;set;}
	  ///<summary>
	  ///已完成的数量
	  ///</summary>
	          public Decimal? F_CompleteQty{get;set;}
	  ///<summary>
	  ///
	  ///</summary>
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_OrderCode != null && 50 < this.F_OrderCode.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_OrderCode should not be greater then 50!");
            }
