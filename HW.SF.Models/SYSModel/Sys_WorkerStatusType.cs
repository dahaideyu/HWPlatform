...
namespace HW.SF.Models.SYSModel
{
    ...
    public class Sys_WorkerStatusType :IBaseModel<string>
    {
	  ...
	  ///
	  ///</summary>
	          public Int32? F_StatusType{get;set;}
	  ///<summary>
	  ///
	  ///</summary>
	          public String F_StatusText{get;set;}
	  ///<summary>
	  ///
	  ///</summary>
	  ...
	  ///</summary>
        ...
        {    
            ...
            if (this.F_StatusText != null && 50 < this.F_StatusText.Length)
            {
                validatorResult = false;
                this.ErrorList.Add("The length of F_StatusText should not be greater then 50!");
            }
